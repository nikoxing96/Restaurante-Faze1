    ...
    <section class="seccion-perfil-usuario">
        ...
        <div class="perfil-usuario-body">
            <div class="perfil-usuario-bio">
                ...
                <p class="texto">Cargo: Bodeguero</p>
            </div>
            <div class="perfil-usuario-footer">
                <ul class="lista-datos">
                    <li><a href="#"><i class="icono fas fa-map-signs"></i> Ingresar/eliminar/editar producto</a></li>
                    <li><a href="#"><i class="icono fas fa-map-signs"></i> Control de stock</a></li>
                    <li><a href="#"><i class="icono fas fa-map-signs"></i> Proveer recetas a cocina</a></li>
                    <li><a href="#"><i class="icono fas fa-map-signs"></i> Calculador de productos pedidos</a></li>
                </ul>
            </div>
